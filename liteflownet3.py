...
if __name__ == '__main__':
    ...
    #tenFirst = torch.FloatTensor(numpy.ascontiguousarray(numpy.array(PIL.Image.open(arguments_strFirst)).transpose(2, 0, 1).astype(numpy.float32) * (1.0 / 255.0)))
    #tenSecond = torch.FloatTensor(numpy.ascontiguousarray(numpy.array(PIL.Image.open(arguments_strSecond)).transpose(2, 0, 1).astype(numpy.float32) * (1.0 / 255.0)))
